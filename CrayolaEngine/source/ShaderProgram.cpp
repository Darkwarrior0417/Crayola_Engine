...
/**
 * @brief Inicializa el ShaderProgram compilando shaders y creando el InputLayout.
 * @param device Dispositivo de renderizado.
 * @param fileName Archivo .fx o .hlsl que contiene los shaders.
 * @param Layout Descripción de la estructura de los vértices.
...
/**
 * @brief Método vacío. Reservado para posibles actualizaciones de estado en shaders.
 */
void
...
/**
 * @brief Asigna los shaders y el InputLayout activos al pipeline de renderizado.
 */
void
...
/**
 * @brief Libera los recursos asociados a los shaders y el input layout.
 */
void
...
/**
 * @brief Crea el InputLayout utilizando el shader compilado y la descripción de los vértices.
 */
HRESULT
...
/**
 * @brief Crea un shader (vertex o pixel) a partir de un archivo fuente.
 * @param device Dispositivo de renderizado.
...
/**
 * @brief Compila un shader desde archivo fuente usando D3DX11.
 * @param szFileName Ruta del archivo shader.
 * @param szEntryPoint Punto de entrada (ej: "VS" o "PS").
 * @param szShaderModel Modelo de shader a compilar (ej: "vs_4_0").
 * @param ppBlobOut Puntero donde se almacena el bytecode compilado.
 */
HRESULT 
